...
@Autonomous(name="LeftConnectionConeAutonomous", group="Robot")
public class ConnectionConeAutonomousLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        else
        {
            ...
            if (labelProcessing == ImageProccessingOpenCV.LabelProcessing.ONE) {
                ...
                gyroTurn(TURN_SPEED, 90);
                connectionSleep(sleepMsec);
                gyroDrive(SECOND_DRIVE_SPEED, 104, 90);
                ...
                gyroTurn(TURN_SPEED, 90);
                connectionSleep(sleepMsec);
                gyroDrive(SECOND_DRIVE_SPEED, 47, 90);
                connectionSleep(sleepMsec);
                gyroTurn(TURN_SPEED, 0);
                connectionSleep(sleepMsec);
